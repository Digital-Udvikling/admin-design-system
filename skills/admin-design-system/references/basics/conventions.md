...
> Props and classes every component shares.
...
There is no `.row` or `.grid` component. Use Tailwind's flex and grid utilities directly — see [Row](../components/row.md) and [Grid](../components/grid.md) for the patterns.

Vanilla projects get those utilities from the [utilities bundle](../getting-started/vanilla.md#utilities-optional). React projects should add [Tailwind](../getting-started/tailwind.md) so the bare class names resolve.
