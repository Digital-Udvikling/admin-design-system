...
For single-field validation, use [Fields](../forms/fields/). For a docs-style note rather than an app alert, this component is the wrong shape — it's built to be loud.
