...
Prefer this prop over passing icon JSX as children — the rendered DOM is identical, but the prop ensures consistent sizing and `aria-hidden`. See [Icons](../../basics/icons/).
