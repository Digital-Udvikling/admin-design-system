...
Sanitize untrusted HTML before injecting it. The wrapper styles markup; it does not filter it.
...
| Class   | Effect                                                                                                                                                                                                                                         |
| ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `prose` | Restores element styling inside the wrapper: `text-sm`, `0.75rem` block rhythm, list markers, underlined links, `<code>` chips, a scrolling `<pre>`, a bordered `<blockquote>`, `h4`–`h6` sizing, and the table look from [Tables](../tables/) |
...
When you control the markup, reach for the dedicated components instead: [Link](../links/), [Table](../tables/), [Code blocks](../code-blocks/).
