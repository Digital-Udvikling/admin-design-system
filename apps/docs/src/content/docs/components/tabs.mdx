...
import { IconLayoutGrid, IconList, IconChartBar } from "@tabler/icons-react";
...
| `Tabs.Tab` | `icon`      | [`IconProp`](../../basics/conventions/#icons) | —            |
...
For a group of independent toggles rather than a single choice, use a [button group](../buttons/#group).
