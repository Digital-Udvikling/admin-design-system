...
Set `--color-system-accent` at `:root` to brand-shift the navbar stripe and `<BrandTile>` for one system. See [Customize › System accent](../../basics/customize/#system-accent).
:::
